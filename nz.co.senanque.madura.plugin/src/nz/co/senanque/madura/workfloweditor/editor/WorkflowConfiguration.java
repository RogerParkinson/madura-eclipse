   ...
   extends SourceViewerConfiguration
{
   ...
   public WorkflowConfiguration(TokenManager tokenManager)
   {
   ...
   {
	  return WorkflowPartitionScanner.getLegalContentTypes();
   }
	  ...
	  ISourceViewer sourceViewer)
   {
	...
	reconciler.setDamager(dr,
			WorkflowPartitionScanner.MADURA_COMMENT);
	...
	reconciler.setDamager(dr,
			WorkflowPartitionScanner.MADURA_CODE);
	reconciler.setRepairer(dr,
			WorkflowPartitionScanner.MADURA_CODE);
	  ...
	  ISourceViewer sourceViewer)
   {
	  ...
	  assistant.setContentAssistProcessor(
		 new WorkflowAssistant(tokenManager,this),
		 WorkflowPartitionScanner.MADURA_CODE);
